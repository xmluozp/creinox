export const enumsLabel = {
    ...
    commonType:["包装类别","抛光","材质","计量单位","运输方式","价格条款","币种", "付款方式", "付款方式英文", "佣金"],
}
...
export const  enums = {
    ...
    commonType:{pack:0,polishing:1,texture:2,unitType:3,shippingType:4,pricingTerm:5,currency:6, paymentType:7, paymentTypeE:8, commission:9 },
}