              ...
              <CardBody>
                ...
                <Grid container  spacing={2}>
                  ...
                  <Grid item lg={4} md={4} xs={12}>
                    <Inputs.MySelect inputid="companyType" hasDefault = {false} options={enums.companyType} disabled={disabled} />
                  </Grid>
                  <Grid item lg={8} md={8} xs={12}>
                  ...
                  <Grid item xs={12}>
                    <Inputs.MyInput
                      inputid="region" multiline rows={1} disabled={disabled} />
                  </Grid>               
                  <Grid item lg={8} md={8} xs={12}>
                    <Inputs.MyInput
                      inputid="address" multiline rows={1} disabled={disabled} />
                  </Grid>
                  <Grid item lg={4} md={4} xs={12}>
                  ...
                  <Grid item lg={6} xs={12}>
                    <Inputs.MyComboboxFK inputid="retriever_id" optionLabel="userName" tableName="user"  disabled={disabled} />
                  </Grid>
                  <Grid item lg={6} xs={12}>
                    <Inputs.MyDatePicker
                      inputid="retriveTime"
                  ...
                  <Grid item lg={4} xs={12}>
                    <Inputs.MyComboboxFK inputid="updateUser_id" optionLabel="userName" tableName="user"  disabled={true} />
                  </Grid>
                  <Grid item lg={4} xs={12}>
                    <Inputs.MyDatePicker
                      inputid="updateAt"
                  ...
                  <Grid item lg={4} md={4} xs={12}>
                  <Grid container spacing={2}>
                    <Grid item xs={12}>todo: 联系人</Grid>
                    <Grid item xs={12}>todo: 银行账户</Grid>
                    <Grid item xs={12}>todo: 图片列表</Grid>
                    <Grid item xs={12}>todo: imageLicense</Grid>
                    <Grid item xs={12}>todo: imageBizCard</Grid>
