...
// ============================================= Modal inputs
const FormInputs = ({ onLoad, getSourceProductOnChange, onChangeSource, isFromSellSubitem, ...props }) => {
  //injectProduct
    ...
    <>
      <Grid container spacing={2}>
        <Grid item lg={6} md={6} xs={12}>
          <Inputs.MySwitch label = {isFromSellSubitem? "搜索对应订单的产品" : "搜索所有产品"} value={isFromSellSubitem} onChange={onChangeSource}/>
        </Grid>
        <Grid item lg={6} md={6} xs={12}>
        ...
        <Grid item lg={9} md={6} xs={12}>
          <Inputs.MyComboboxAsyncFK
            ...
            actionName={isFromSellSubitem ? "get_disposable_dropdown_fromSellcontract" : "get_disposable_dropdown"}
